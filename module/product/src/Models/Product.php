...
class Product extends Model
{
    ...
    protected $fillable = ['name','slug','cat_id','company_id','price','disprice','discount','description','content','meta_desc','meta_title','thumbnail','display','count_view','user_post'
