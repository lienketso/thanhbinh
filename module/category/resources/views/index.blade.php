...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            ...
            <p>Danh sách Danh mục trên trang</p>
        </div>
                ...
                <div class="row">
                    <form method="get">
                        ...
                        <div class="col-sm-2">
                            ...
                            <a href="{{route('wadmin::category.index.get')}}" class="btn btn-default">Làm lại</a>
                        </div>
                        <div class="col-sm-5">
                            <div class="button_more">
                                <a class="btn btn-primary" href="{{route('wadmin::category.create.get')}}">Thêm mới</a>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <table class="table nomargin">
                    ...
                    @foreach($data as $d)
                        <tr>
                            ...
                            <td><a href="{{route('wadmin::category.change.get',$d->id)}}"
                                   class="btn btn-sm {{($d->status=='active') ? 'btn-success' : 'btn-warning'}} radius-30">
                                    {{($d->status=='active') ? 'Đang hiển thị' : 'Tạm ẩn'}}</a></td>
                            <td>
                                <ul class="table-options">
                                    <li><a href="{{route('wadmin::category.edit.get',$d->id)}}"><i class="fa fa-pencil"></i></a></li>
                                    <li><a class="example-p-6" data-url="{{route('wadmin::category.remove.get',$d->id)}}"><i class="fa fa-trash"></i></a></li>
                                </ul>
                            </td>
                        </tr>
                    @endforeach
