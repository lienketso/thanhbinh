...
<section>
    <div class="gap black-layer opc8 overlap144">
        <div class="fixed-bg2" style="background-image: url('{{upload_url($catInfo->thumbnail)}}');"></div>
        <div class="container">
            <div class="pg-tp-wrp">
                <h1 itemprop="headline">{{$catInfo->name}}</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('frontend::home')}}" title="Trang chủ" itemprop="url">{{trans('frontend.home')}}</a></li>
                    <li class="breadcrumb-item"><a href="{{route('frontend::blog.index.get',$catInfo->slug)}}" title="{{$catInfo->name}}" itemprop="url">{{$catInfo->name}}</a></li>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-lg-4">
                                                <div class="blg-bx">
                                                    <div class="blg-thmb blg_news">
                                                        <a href="{{route('frontend::blog.detail.get',$d->slug)}}" title="" itemprop="url">
                    ...
                    <div class="col-md-3 col-sm-6 col-lg-3">
                        <div class="sidebar-wrp remove-ext7">
                            ...
                            <div class="wdgt-bx-cd">
                                ...
                                <ul class="cat-lst-se">
                                    @foreach($listCat as $d)
                                    <li><a href="{{route('frontend::blog.index.get',$d->slug)}}" title="{{$d->name}}"
