...
$config['LicenseName'] = 'Liên Kết Số';
$config['LicenseKey'] = 'AF92D7QVR75PX98KGX3LAJG458T8NQ3J';
/*
...
directory, no matter the resources type.
*/
...
the "Logos" folder of the resources type "Images", you may uncomment the
...
"DefaultResourceTypes" settings is used (may contain the resources type names
...
$config['ResourceType'][] = Array(
		'name' => 'HINH-ANH',
		'url' => $baseUrl . 'public/'.date('Y').'/'.date('m'),
		'directory' => $baseDir . 'public/'.date('Y').'/'.date('m'),
		'maxSize' => 0,
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
		'deniedExtensions' => '');
$config['ResourceType'][] = Array(
		'name' => 'TAP-TIN',				// Single quotes not allowed
		'url' => $baseUrl . 'files',
